...
namespace mmGameEngine
{
	public static class Vector2Ext
	{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void Transform(Vector2[] sourceArray, int sourceIndex, ref Matrix3x2 matrix,
		...
		/// <param name="destinationArray">Destination array.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void Transform(Vector2[] sourceArray, ref Matrix3x2 matrix, Vector2[] destinationArray)
		{
