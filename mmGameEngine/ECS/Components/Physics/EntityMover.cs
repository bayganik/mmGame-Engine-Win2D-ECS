...
namespace mmGameEngine
{
    public class EntityMover : Component
    {
        ...
        public override void Update()
        {
			...
			Transform.Position += moveDir * (float)(this.Speed * Global.DeltaTime);

			if (DoesRotate)
				Transform.Rotation += (float)(RotationSpeed * Global.DeltaTime) * 1;
			//
		...
		private void Move(Vector2 motion)
        {
			...
			Transform.Position += motion * (float)(this.Speed * Global.DeltaTime);
